...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-CVnhAvi8.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-6cCw-6Kw.js', import.meta.url).href),import:true},'@apollo/client':{get:()=>()=>__federation_import(new URL('__federation_shared_@apollo/client-DqJHpL7f.js', import.meta.url).href),import:true},'graphql':{get:()=>()=>__federation_import(new URL('__federation_shared_graphql-Btffuhav.js', import.meta.url).href),import:true}};
